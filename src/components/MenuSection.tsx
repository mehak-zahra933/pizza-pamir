      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
              ...
              <article className="group shadow-card h-full overflow-hidden rounded-2xl border border-border/70 bg-card transition-all duration-500 hover:-translate-y-2 hover:shadow-lift">
                ...
                <div className="flex flex-col gap-3 p-6">
                  ...
                  <a
                    ...
                    className="mt-2 inline-flex h-11 items-center justify-center gap-2 rounded-full border border-border text-sm font-medium transition-colors duration-300 hover:border-accent hover:text-accent"
                  >
        ...
        <Reveal className="mt-14 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-14 items-center justify-center rounded-full bg-primary px-9 text-base font-medium text-primary-foreground transition-transform duration-300 hover:-translate-y-0.5"
          >
            View Full Menu
          </a>
        </Reveal>
