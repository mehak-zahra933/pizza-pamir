...
import { locations, PHONE_LINK, WHATSAPP_NUMBER } from "@/lib/site-data";
        ...
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <WhatsAppDialog>
                <button
                  aria-label="WhatsApp"
                  className="inline-flex size-11 items-center justify-center rounded-full border border-cream/20 text-cream transition-colors hover:border-accent hover:text-accent cursor-pointer"
                >
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm text-cream/75">
              <li>
                <WhatsAppDialog>
                  <button className="inline-flex items-center gap-2 transition-colors hover:text-accent cursor-pointer">
                    <MessageCircle className="size-4" aria-hidden="true" />
                    Order on WhatsApp
                  </button>
                </WhatsAppDialog>
